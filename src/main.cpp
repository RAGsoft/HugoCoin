...
uint256 hashGenesisBlock("0xb2fff97b8c522c4370d3d6784d51f8d93fdcda9171fdf2a1ad14e4cbb0025606");
...
const string strMessageMagic = "HugoCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 12 * 60 * 60; // HugoCoin: 1 days
static const int64 nTargetSpacing = 240; // HugoCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal HugoCoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "HugoCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x171d60b8c7d5a1398d96f159d89cb24a8f2cfc7b496917639d9262a42318f05f");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "HugoCoin Grand Opening";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1383441037; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 740472;

        if (fTestNet)
        {
            block.nTime    = 1383435089;
            block.nNonce   = 659154;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x2e7fb29d0ffa046ea0df53cf71f4d982f862ad295ae2b7260e9fb8d45c417d34"));
